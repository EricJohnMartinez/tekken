                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <p style="font-family: Arial, sans-serif;"><i class="bi bi-building"></i> Works at
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form
                                                    action="{{ $surveyStatus === 'completed' && auth()->user()->survey ? route('survey.update', auth()->user()->survey->id) : route('survey') }}"
                                                    method="POST">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="permanent_home_address" class="form-label">Permanent
                                                            Home Address</label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="position_on_work" class="form-label">Position on
                                                            Work</label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="employed_status" class="form-label">Employed
                                                            Status</label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="civil_service" class="form-label">Civil
                                                            Service</label>
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-primary">{{ $surveyStatus === 'completed' ? 'Update' : 'Submit' }}</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
