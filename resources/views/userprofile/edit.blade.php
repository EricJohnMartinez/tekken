                ...
                <div class="card ">
                    <div class="card-body ">
                        <div class="row">
                            ...
                            object-fit: contain;"
                                        src="{{ Auth::user()->media_url }}" alt="Profile Photo"
                                ...
                                <form action="{{ route('userprofile.update', Auth::user()->id) }}" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="department" id="department" class="form-control">
                                            ...
                                            <option value="sales"
                                                {{ Auth::user()->department === 'sales' ? 'selected' : '' }}>Sales</option>
                                            <option value="marketing"
                                                {{ Auth::user()->department === 'marketing' ? 'selected' : '' }}>Marketing
                                            </option>
                                            <option value="finance"
                                                {{ Auth::user()->department === 'finance' ? 'selected' : '' }}>Finance
                                            </option>
                                            <option value="human resources"
                                                {{ Auth::user()->department === 'human resources' ? 'selected' : '' }}>
